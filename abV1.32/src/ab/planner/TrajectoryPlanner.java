...
public class TrajectoryPlanner {
    ...
    public ArrayList<Point> estimateLaunchPoint(Rectangle slingshot, Point targetPoint) {
        ...
        System.out.println("slingshot "+ slingshot + "scale " + scale);
        Point ref = getReferencePoint(slingshot);
        System.out.println("C_Slings " + ref); // coordenadas de la honda
        ...
        System.out.println("Velcidad " + _scaleFactor + " " + _launchVelocity[6]);
        ...
        System.out.println("ANGULOS " + t1 + " " + t2);
    ...
    public Point findReleasePoint(Rectangle sling, double theta)
    {
        ...
        System.out.println("mag: " + mag + ", " + theta );
